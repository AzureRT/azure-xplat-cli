...
exports.init = function (cli) {
  ...
  vmssQuickCreate.command('quick-create [resource-group-name] [name] [location] [image-urn] [admin-username] [admin-password] [capacity]')
  .description($('Commands to create a virtual machine scale set with default resources in a group.'))
  .usage('[options] <resource-group-name> <name> <location> <image-urn> [admin-username] [admin-password] [capacity]')
  ...
  .execute(function (resourceGroupName, name, location, imageUrn, adminUsername, adminPassword, capacity, options, _) {
