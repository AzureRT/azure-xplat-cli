...
function createStorageResources(storageManagementClient, resourceGroupName, name, hash, location, capacity, _) {
...
exports.init = function (cli) {
  ...
  .execute(function (resourceGroupName, name, location, imageUrn, capacity, adminUsername, adminPassword, options, _) {
    ...
    var stoNames = createStorageResources(storageManagementClient, resourceGroupName, name, hash, location, 5, _);
